...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "f28e43d9-6e2f-4a49-a050-594b5bda8a3e");
    ...
    onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        <div className='grid grid-cols-auto gap-6 mt-10 mb-8'>
            ...
            className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-whites dark:bg-darkHover/30 dark:border-white/90' name='email'/>
        ...
        type='submit' 
        className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent 
