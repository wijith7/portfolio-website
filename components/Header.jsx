...
const Header = () => {
  return (
    <div className=' w-11/12 max-w-3xl text-center mx-auto h-auto flex flex-col items-center justify-center gap-1 pt-20'>
        ...
        I am an software engineer with two years of experience, currently expanding my expertise in data science, 
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            href="/Resume_Wijith_Pathiranage.pdf" download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark: text-black'
